...
Electrical and Electronics Engineer working at the intersection of embedded firmware, cybersecurity, and autonomous systems.

My path runs from university robotics championships, through an AI research thesis in Brussels, to production firmware for EV charging infrastructure today — each step building the same underlying skill: making complex systems reliable under real constraints.
...
![Frontend](https://img.shields.io/badge/Frontend-000000?style=flat-square&logo=webcomponents.org&logoColor=white)
![Embedded Linux](https://img.shields.io/badge/Embedded_Linux-000000?style=flat-square&logo=linux&logoColor=white)
